...
async function run() {
    ...
    const misdatedKms22 = [];
    // using UTC Date 23 May for comparison
    const _22MayEpoch = new Date('2026-05-22T00:00:00.000Z').getTime();
    ...
    for (const en of entries.docs) {
        const data = en.data();
        // if this entry is for the KM we're looking for, AND it was marked as May 23
